...
//            listar();
    ...
    public void generarReporte(int IDINCTIP) throws Exception {
        IncidenciaTipoImpl report = new IncidenciaTipoImpl();
        try {
            Map<String, Object> parameters = new HashMap(); // Libro de parametros
            parameters.put("IDINCTIP", IDINCTIP); //Insertamos un parametro
