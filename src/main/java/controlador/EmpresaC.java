...
public class EmpresaC implements Serializable {
    ...
    private List<Empresa> lstEmpresa, lstEmpresaFiltrado;
    ...
    public EmpresaC() {
        ...
        lstEmpresaFiltrado = new ArrayList<>();
    }
...
//            listarEmpresa();
    ...
    public List<Empresa> getLstEmpresaFiltrado() {
        return lstEmpresaFiltrado;
    }

    public void setLstEmpresaFiltrado(List<Empresa> lstEmpresaFiltrado) {
        this.lstEmpresaFiltrado = lstEmpresaFiltrado;
    }
