...
public class ContactoImpl {
    ...
    public String enviarMensajeDesarrolladores(final Contacto contacto) {
        ...
        try {
            mensaje.setSubject(contacto.getSubject());
            mensaje.setContent(contacto.getDescription() + "\n"
                    + " Mi celular ("
                    + servicios.SesionS.getSesion().getTrabajador().getPersona().getCELPER()
                    + " )"
                    + "\n"
                    + " Mi Correo ("
                    + servicios.SesionS.getSesion().getTrabajador().getPersona().getCORPER()
                    + " )",
                    "text/plain");
            ...
            Address toAddresses[] = {
                new InternetAddress("martin.saman@vallegrande.edu.pe"),
                new InternetAddress("jesus.cardenas@vallegrande.edu.pe"),
                new InternetAddress("jose.levano@vallegrande.edu.pe"),
                new InternetAddress("lmanzo@vallegrande.edu.pe"),
                new InternetAddress("gvalencia@vallegrande.edu.pe")
            };
