...
public class DocumentoTipoImpl extends Conexion implements ICrud<DocumentoTipo>, IReporte<DocumentoTipo> {
    ...
    public List<DocumentoTipo> listar() throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "SELECT IDTIPDOC, NOMTIPDOC, ESTTIPDOC, TIPDOC FROM TIPO_DOCUMENTO where  ESTTIPDOC != 'I' ORDER BY IDTIPDOC DESC ";
            ...
            while (rs.next()) {
                ...
                documento.setNOMTIPDOC(rs.getString(2));
                documento.setESTTIPDOC(rs.getString(3));
                documento.setTIPDOC(rs.getString(4));
