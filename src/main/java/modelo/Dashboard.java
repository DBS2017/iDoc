...
public class Dashboard {
   ...
   //===== bandeja
    private Transferencia transferenciaban = new Transferencia();
    private int cantidadban;
    
        public int getCantidadban() {
        return cantidadban;
    }

    public void setCantidadban(int cantidadban) {
        this.cantidadban = cantidadban;
    }

    public Transferencia getTransferenciaban() {
        return transferenciaban;
    }

    public void setTransferenciaban(Transferencia transferenciaban) {
        this.transferenciaban = transferenciaban;
    }
